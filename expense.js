function saveToAxios(event)
{
    ...
    axios.post("https://crudcrud.com/api/9e23523eb6ad4a3a8fdacec2a7df4bcf/expenseData",expense)
    .then((respone) => {
...
window.addEventListener("DOMContentLoaded",()=>{
    ...
    axios.get("https://crudcrud.com/api/9e23523eb6ad4a3a8fdacec2a7df4bcf/expenseData")
    .then((response)=>{
...
function deleteExpense(expenseId)
{
    ...
    axios.delete(`https://crudcrud.com/api/9e23523eb6ad4a3a8fdacec2a7df4bcf/expenseData/${expenseId}`)
    .then((response)=>{
